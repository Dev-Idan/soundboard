...
import badumtssSound from '@/assets/audio/badumtss.mp3';
...
export const soundList = [
	{ title: 'TADA', path: tadaSound },
	{ title: 'BA DUM TSS', path: badumtssSound },
	{ title: 'BOO', path: booSound },
	{ title: 'DRUMROLL', path: drumrollSound },
